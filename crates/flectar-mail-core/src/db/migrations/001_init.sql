...
INSERT INTO labels (name, color, keyword, position, is_auto) VALUES
  ('Marketing', '#e0708a', 'FlectarMailAutoMarketing', 1000, 1),
  ('News',      '#5b9dd9', 'FlectarMailAutoNews',      1001, 1),
  ('Social',    '#7bc47f', 'FlectarMailAutoSocial',    1002, 1),
  ('Pitch',     '#c9a04e', 'FlectarMailAutoPitch',     1003, 1);
