...
/// Insert an event created in Flectar Mail (we are the organizer).
#[allow(clippy::too_many_arguments)]
pub fn insert_local(
    conn: &Connection,
    account_id: i64,
...
mod tests {
    ...
    fn dirty_and_tombstone_lifecycle() {
        ...
        remote.uid = "u1@flectar-mail".into();
